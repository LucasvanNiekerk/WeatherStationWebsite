...
var baseUri = "https://weatherstationrest2019.azurewebsites.net/api/values";
...
function showOneCar() {
    ...
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(uri)
        .then(function (response) {
        var result = "ID: " + response.data.id + ". Model: " + response.data.model + ". Price: " + response.data.price + ". Vendor: " + response.data.vendor + ".";
        outputOneElement.innerHTML = result;
    })
        .catch(function (error) {
        if (error.response) {
            // the request was made and the server responded with a status code
...
function addCar() {
    var addModelElement = document.getElementById("addModel");
    var addVendorElement = document.getElementById("addVendor");
    var addPriceElement = document.getElementById("addPrice");
    var myModel = addModelElement.value;
    var myVendor = addVendorElement.value;
    var myPrice = Number(addPriceElement.value);
    var output = document.getElementById("contentAdd");
    // id is generated by the back-end (REST service)
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUri, { model: myModel, vendor: myVendor, price: myPrice })
        .then(function (response) {
